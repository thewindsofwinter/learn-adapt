...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-jetBlack-400 to-jetBlack-600 text-platinum-500">
  <div className="text-center">
    ...
    <div className="border w-fit text-vermillion-400 hover:text-vermillion-600 border-vermillion-400 hover:border-vermillion-600 rounded p-2 m-auto mt-4">
      <Link
        href={{
          pathname: "/help",
        }}
